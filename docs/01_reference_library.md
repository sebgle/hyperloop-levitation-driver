...
|---|---|---|
| **IR2184 datasheet** (PD60174 Rev. G, Infineon/IR) · [PDF](https://www.infineon.com/assets/row/public/documents/24/49/infineon-ir21844s-datasheet-en.pdf) | The driver in the current BOM. 600 V floating channel, 1.4 A source / 1.8 A sink, programmable deadtime 280–520 ns. | The **V_BS UVLO 8.0–9.8 V rising** spec — this is what sets your bootstrap refresh requirement. And the **R_DT deadtime table**. |
